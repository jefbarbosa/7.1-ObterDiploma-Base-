...
import com.meli.obterdiploma.exception.DiplomaException;
...
@ControllerAdvice
public class ObterDiplomaException {

    @ExceptionHandler(DiplomaException.class)
    ResponseEntity<ErrorDTO> handleGlobalExceptions(DiplomaException e) {
        e.printStackTrace();
